...
class FileOptions {
  ...
  public function buildContent() {
    ...
    if (!$this->fileManager->originalFileExists()) {
      ...
      $build['content'] .= '<p>Please <a href="/upload">upload a CSV</a> to begin.'
        . '</p>';
    }
    else {
      $build['menu'][] = [
      ...
      $build['content'] .= '</p>Welcome back to the RedCat Systems coding challenge.'
        . '</p>';
      ...
      $build['content'] .= ' (doing this will delete your previously uploaded data).'
        . '</li>';
      $build['content'] .= '<li><a href="/data/original/view">Work with your '
        . 'previously uploaded data</a>';
      if ($this->fileManager->alteredFileExists()) {
        $build['menu'][] = [
          'link' => '/data/altered/view',
          'title' => 'View Altered Data',
        ];
        $build['content'] .= ' (this will override your previously altered and '
          . 'saved data).</li>';
        $build['content'] .= '<li><a href="/data/altered/view">Work with your '
          . 'previously uploaded and altered data</a>';
      }
      $build['content'] .= '.</li></ul>';
    }
